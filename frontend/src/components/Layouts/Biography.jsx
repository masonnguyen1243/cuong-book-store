const Biography = () => {
  return (
    <section className="container mx-auto mt-[200px] flex items-center justify-between">
      <div className="w-1/2">
        <img
      ...
      <div className="ml-40 w-1/2">
        ...
        <h2 className="mb-4 text-[48px] font-medium">John Roberts</h2>
        ...
        <button className="border-main text-main hover:bg-main mt-10 rounded-md border px-[23px] py-[15px] transition-all duration-300 hover:text-white">
          Read more
        </button>
      </div>
    </section>
